...
class AgentsTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        cards_frame = _AppleContainer(radius=14, parent=self)
        cards_layout = cards_frame.inner_layout()
        ...
        log_frame = _AppleInset(radius=12, parent=self)
        log_layout = log_frame.inner_layout()
